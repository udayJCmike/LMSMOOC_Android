		...
		class CategoryDetails extends AsyncTask<String,String,String>{
		    ...
		    protected void onPreExecute() {
				...
				protected String doInBackground(String... args) {
		         ...
		         jArray = jsonParser.makeHttpRequest(Config.ServerUrl+Config.unfavoritecategoryurl, "POST", params1);
				    ...
				    try
				    {
				    	...
				    	for(int i=0;i<user.length();i++)
				    	{
				    	    ...
				    	    UnfavoriteCourses cnt = new UnfavoriteCourses(category_name,false);
							    cnt.setName(category_name);
							  
				               category.add(cnt);
				    		
				    		System.out.println("size of aray list"+category.size());
...
//			          pDialog.show();
					...
					protected String doInBackground(String... params) {
			           ...
			           JSONObject json = jLogin.makeHttpRequest(Config.ServerUrl+Config.addtomyfavoritecategoryurl,"POST", params1);
