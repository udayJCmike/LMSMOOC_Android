...
public class InboxFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.inboxfragment, container,
				false);

		ActionBar ab = getActivity().getActionBar();

		ab.setTitle(Html.fromHtml("<font color=\"white\">" + "Inbox" + "("
				+ String.valueOf(a) + "/" + allinbox.size() + ")" + "</font>"));
	...
	public class Details extends AsyncTask<String, String, String> {
			...
			try {
				if (jArray != null) {
					...
					for (int i = 0; i < user.length(); i++) {
						...
						Inbox cnt = new Inbox(senderid, inboxid, sendername,
								receiverid, receivername, role, subject,
								message, readstatus, sentdate, importantstatus);
		...
		protected void onPostExecute(String file_url) {
			...
			list2.setAdapter(new InboxArrayAdapter(InboxFragment.this
					.getActivity(), allinbox, R.layout.inboxlist));
			...
			list2.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					Intent i = new Intent(InboxFragment.this.getActivity(),
							InboxDetails.class);
		...
		private void run(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			// TODO Auto-generated method stub
			read = allinbox.get(arg2).getreadstatus();
			...
			ActionBar ab = getActivity().getActionBar();
			ab.setTitle(Html.fromHtml("<font color=\"white\">" + "Inbox" + "("
					+ String.valueOf(a) + "/" + allinbox.size() + ")"
					+ "</font>"));
