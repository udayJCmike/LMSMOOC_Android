...
//		private static final String TAG_Check_= "checkmycourse";
    ...
    class GrabURL extends AsyncTask<String,Void,String>{
	    ...
	    protected void onPreExecute() {
			  cDialog = new ProgressDialog(CategoryCourses.this);
			...
			protected void onPostExecute(String file_url) {
				 ...
				 cDialog.dismiss();
				   Toast toast;
				   if (error) {
				    toast = Toast.makeText(CategoryCourses.this, 
			...
			protected String doInBackground(String... urls) {
			    ...
			    jArray = jsonParser.makeHttpRequest(Config.ServerUrl+Config.categoryselectionurlbrowse, "POST", nameValuePairs);
			    JSONObject c = jArray.getJSONObject(TAG_SRES);
		    	Log.i("tagconvertstr", "["+c+"]");
...
//              .execute((String) country.getstringurl());
    ...
    class fetchpurnumber extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CategoryCourses.this);
