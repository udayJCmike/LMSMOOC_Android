...
//	            pDialog.show();
			...
			protected String doInBackground(String... params) {
	             ...
	             JSONObject json = jLogin.makeHttpRequest(Config.ServerUrl+Config.coursecontenttext,"POST", params1);
               System.out.println("value for jsdfgdfon::"+json);
	             if(json!=null)
	             {
	                 try
	                 {
			 ...
			 protected void onPostExecute(String file_url) {
				...
				alertDialog.show();
		          ...
		          else
		          {
		        	...
		        	//  course_content.setText((Html.fromHtml("<font color=\"black\">" +course_contents + "</font>")));
